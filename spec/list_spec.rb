...
describe List do
  ...
  describe "instances" do
    ...
    it "should be able to make a new story object given path, name and title" do
      Story.expects(:new).with('grouping/what_a_good.story', 'Item title').returns(:story)
    ...
    it "should be able to make a new story object given name and title" do
      Story.expects(:new).with('dir/stories/what_a_good.story', 'Item title').returns(:story)
